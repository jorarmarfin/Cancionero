    ...
    <body>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="logo text-center">
                            <h1>Tuya es nuestra alabanza</h1>
                            <span>Cancionero de musica</span>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="menu-item color responsive">
                                    <a href="{{route('secciones')}}" data-toggle="modal">
                            ...
                            <div class="col-md-3">
                                <div class="menu-item light-orange responsive">
                                    <a href="{{route('temas')}}" data-toggle="modal">
        ...
        <div class="copyright text-center">
            <div class="footer">
                <div class="row">
                    <div class="col-md-12">
                        <div>"Cantad al señor un cantico nuevo" Salmo 149</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="section-modal modal fade" id="service-modal" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-content">
                ...
                <div class="container">
                    <div class="row">
                        <div class="section-title text-center">
                            <h3>Canciones en orden alfabetico</h3>
                            <p>Duis aute irure dolor in reprehenderit in voluptate</p>
                        </div>
                    </div>
                    <div class="row">
